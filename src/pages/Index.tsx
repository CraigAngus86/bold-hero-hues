...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      {/* Section Divider */}
      <div className="w-full h-8 bg-gradient-to-r from-team-navy via-team-blue to-team-lightBlue"></div>
      ...
      <div className="relative h-24 overflow-hidden">
        ...
        <div className="absolute -bottom-10 left-0 right-0 h-24 bg-team-navy transform -skew-y-2"></div>
      </div>
      ...
      {/* Diagonal Section Divider */}
      <div className="relative h-24 overflow-hidden">
        <div className="absolute inset-0 bg-team-navy"></div>
        <div className="absolute -bottom-10 left-0 right-0 h-24 bg-gray-50 transform skew-y-2"></div>
      </div>
      ...
      <div className="relative h-24">
        <svg className="absolute top-0 w-full h-24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">

...
export const fixtureToMatch = (fixture: Fixture | FixtureExtended): Match => {
  return {
    ...
    attendance: fixture.attendance ? String(fixture.attendance) : undefined,
...
export const matchToFixture = (match: Match): Fixture => {
  return {
    ...
    home_score: match.homeScore ? Number(match.homeScore) : undefined,
    away_score: match.awayScore ? Number(match.awayScore) : undefined,

...
export default function FixturesScraper() {
  ...
  const [activeMethod, setActiveMethod] = useState<'hfl' | 'bbc' | 'rss' | 'firecrawl'>('hfl');
  ...
  const handleTestFetch = async () => {
    try {
      ...
      if (activeMethod === 'hfl') {
        result = await FirecrawlService.fetchHighlandLeagueWebsite();
      } else if (activeMethod === 'bbc') {
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-4">
        <Tabs defaultValue="hfl" onValueChange={(v) => setActiveMethod(v as 'hfl' | 'bbc' | 'rss' | 'firecrawl')}>
          <TabsList>
            <TabsTrigger value="hfl">
          ...
          <TabsContent value="hfl" className="space-y-4 pt-4">
            <Alert>
              <Globe className="h-4 w-4" />
              <AlertTitle>Official Highland League Website</AlertTitle>
              <AlertDescription>
                This method fetches fixtures directly from the official Highland League website.
                It's the most authoritative source for fixtures and results.
              </AlertDescription>
            </Alert>
          </TabsContent>
          ...
          <TabsContent value="bbc" className="space-y-4 pt-4">
            <Alert>
              ...
              <AlertDescription>
                ...
                It's a reliable source for current fixtures and results.
              </AlertDescription>
            </Alert>
          </TabsContent>
          ...
          <TabsContent value="rss" className="space-y-4 pt-4">
            <Alert>
              ...
              <AlertTitle>RSS Feed Access</AlertTitle>
              <AlertDescription>
                This method fetches from the Highland League RSS feed using a CORS proxy. No API key required.
              </AlertDescription>
            </Alert>
          </TabsContent>
            ...
            <AccordionContent>
              <div className="space-y-3 text-sm">
                ...
                <p className="text-gray-600">
                  This tool now uses multiple methods to fetch Highland League data:
                </p>
                <ol className="list-decimal list-inside space-y-1">
                  <li><strong>Highland League Website:</strong> Fetches directly from the official website (most authoritative)</li>
                  <li><strong>BBC Sport:</strong> Fetches fixtures from the BBC Sport website (reliable)</li>
                  <li><strong>RSS Feed:</strong> Fetches from the Highland League RSS feed</li>
                  <li><strong>Firecrawl API:</strong> Used as a backup if other methods fail</li>
                </ol>
